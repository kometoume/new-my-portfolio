...
export const metadata: Metadata = {
  ...
  description:
    "Michie Yagi のポートフォリオサイトです。Web開発の経験とスキルを紹介しています。", // サイトの説明
};
          ...
          */}
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 hanging-indent">
              ...
              <li>
                正社員のWebコーダーとして5年間、フルリモート環境下で業務に従事
              </li>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 hanging-indent">
              <li>
                現在はプログラマーとして勤務していますが、コーダーやデザイナーとしてWeb制作の現場に再び携わりたいと考えています。特に、デザインとコーディングを一貫して行うスキルを活かして、より魅力的で使いやすいWebサイトを作ることで、制作のクオリティ向上に貢献したいと思っています。デザインスキルの向上を目指しており、Udemyを活用してUI/UXデザインやデザインツールの習得を進めています。
              </li>
            </ul>
          </div>
        </div>
