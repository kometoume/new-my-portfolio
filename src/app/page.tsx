        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          */}
          <div>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Web制作に携わる中で、より高い専門性を身につけ、スキルを向上させたいという思いが強まり、今後の成長を見据えて転職を決意いたしました。このポートフォリオサイトは、ReactとNext.jsで開発しています。現在はTailwind CSS、TypeScript、Node.js、Firebaseなど、幅広い技術を積極的に学習中です。また、GitやGitHubを用いたバージョン管理にも取り組み、実務での経験を活かしながら、常に新しい知識を吸収し柔軟に対応できる力を身につけています。さらなる成長を目指して、前向きに取り組んでまいります。
            </p>
