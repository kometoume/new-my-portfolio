        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          */}
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 hanging-indent">
              <li>
                現在はプログラマーとして勤務していますが、コーダーやデザイナーとしてWeb制作の現場に再び携わりたいと考えています。特に、デザインとコーディングを一貫して行うスキルを活かして、より魅力的で使いやすいWebサイトを作ることで、制作のクオリティ向上に貢献したいと思っています。
              </li>
              <li>デザインスキルの向上を目指しており、Udemyを活用して自己学習を進めています。</li>
            </ul>
          </div>
        </div>
      </section>
