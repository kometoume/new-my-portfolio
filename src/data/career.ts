...
export const careerEntries: CareerEntry[] = [
  {
    ...
    achievements: [
      ...
      {
        title: "HubSpotを活用した情報発信・メール配信の効率化",
        period: "2025年12月～",
        overview:
          "メルマガ配信、SNS投稿、Webサイト掲載など複数チャネルでの情報発信や、フォーム回答後の案内メール送付に手間がかかっていた",
        task: "HubSpotでのメルマガ配信に加え、X投稿やサイト掲載も担当。フォーム回答者やセミナー案内メールを自動配信するワークフローをHubSpotで構築し、さらに情報を入力するだけで文面を作成できるプロンプトを整備して作業を効率化",
        result:
          "複数チャネルへの発信とメール配信の自動化フローを整備し、少ない工数で継続的に運用できる体制を構築",
      },
    ],
    points: [
