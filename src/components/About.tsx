      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div>
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            はじめまして。八木美智惠と申します。
            大学院修了後、美術教員および教育機関の助手として教育現場で経験を積みました。その後、職業訓練校での学びを経て、正社員のWebデザイナー・コーダーとして5年間、フルリモート環境下でWeb制作業務に従事しました。現在はプログラマーとして、ReactやVue.jsを用いたフロントエンドの開発に携わっています。GitHubを用いたチーム開発を行っており、コードレビューやブランチ運用を通じてチーム開発の効率化と品質向上に取り組んでいます。
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            現在はプログラマーとして勤務していますが、Web制作の現場に再び携わりたいと考えています。「デザインからコーディングまでを自身で手がけられるスキル」を活かして、より魅力的で使いやすいWebサイトを生み出し、制作全体のクオリティ向上に貢献したいと考えています。
          </p>
        </div>
      </div>
    </section>
